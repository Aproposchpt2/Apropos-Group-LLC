...
const properties = [
  ...
  { name: 'Registered Federal Contractors Portal', alternateName: 'RFCP', url: 'https://rfcp.aproposgroupllc.com/', audience: 'Businesses registered to pursue federal contracting opportunities', purpose: 'Federal contractor opportunity intelligence and guided access to relevant procurement pathways.' },
